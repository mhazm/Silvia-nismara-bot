const config = {
    ...
    users: {
        ...
        developers: ['Account ID', 'Another account ID'], // The bot developers, remember to include your account ID with the other account IDs.
        roles: {
            driver: ["Role Driver ID"],
            manager: ["Role Manager ID"],
            moderator: ["Role Moderator ID"],
        },
    },
    messages: { // Messages configuration for application commands and message commands handler.
        ...
        MISSING_REQUIRED_ROLE: 'Eeem... Sepertinya kamu tidak memiliki role yang diizinkan untuk menjalankan command ini.',
