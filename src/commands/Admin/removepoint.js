...
module.exports = new ApplicationCommand({
    ...
    run: async (client, interaction) => {
        ...
        if (driver.bot) return interaction.editReply("❌ Kamu tidak bisa mengurangi poin bot.");
        ...
        if (!pointData) return interaction.editReply("❌ Driver ini belum memiliki data poin.");
